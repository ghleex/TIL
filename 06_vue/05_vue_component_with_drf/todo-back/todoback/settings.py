...
SECRET_KEY = '09kqz9coxlho3i0phy&p+-byjkln0g$@_xza&fw=*#%*f1)g%3'
...
# 기존에는 다음과 같이 허용할 도메인 리스트를 작성해야 하나,
# 개발 테스트 단계이므로 모든 요청을 허용하기 위하여 주석 처리
